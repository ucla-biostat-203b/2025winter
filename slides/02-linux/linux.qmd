...
- We will learn more about regex in the [strings and regex](https://ucla-biostat-203b.github.io/2024winter/slides/09-strings/stringr.html) lecture.
...
{{< video https://www.youtube.com/embed/1kJaLt4Wa30 >}}
...
### Steps to generate keys (on ternminal)
...
- Demo script [`meanEst.R`](https://raw.githubusercontent.com/ucla-biostat-203b/2024winter/master/slides/02-linux/meanEst.R) implements an (terrible) estimator of mean
$$
...
- [`runSim.R`](https://raw.githubusercontent.com/ucla-biostat-203b/2024winter/master/slides/02-linux/runSim.R) has components: (1) **command argument parser**, (2) method implementation, (3) data generator with unspecified parameter `n`, and (4) estimation based on generated data.
```{bash}
#| echo: false
cat runSim.R
```
...
- Suppose we have 
    - [`runSim.R`](https://raw.githubusercontent.com/ucla-biostat-203b/2024winter/master/slides/02-linux/runSim.R) which runs a simulation based on command line argument `n`.  
...
- Let's demonstrate using the script [autoSim.R](https://raw.githubusercontent.com/ucla-biostat-203b/2024winter/master/slides/02-linux/autoSim.R)
```{bash}
cat autoSim.R
```

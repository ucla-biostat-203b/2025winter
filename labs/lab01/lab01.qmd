...
You will thank me for this suggestion. First [enable GitHub Copilot](https://docs.github.com/en/copilot/quickstart) in your GitHub account (Student Developer Pack). Then in RStudio Desktop, go to `Tools` -> `Global Options...` -> `Copilot` -> `Enable GitHub Copilot` -> `Apply`.
:::
...
```{bash}
#| eval: false
git clone https://github.com/ucla-biostat-203b/2025winter.git ~/203b-lecture
```
